package base.ch15.example8;

import base.ch15.PoolLoopHandler;
...
public class SinTable extends PoolLoopHandler {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("Results: " + results[0][0] + ", " + results[0][1] + ", " + results[0][2] + ", " + "...");
        System.out.println("Results: " + results[1][0] + ", " + results[1][1] + ", " + results[1][2] + ", " + "...");
        System.out.println("Results: " + results[2][0] + ", " + results[2][1] + ", " + results[2][2] + ", " + "...");
