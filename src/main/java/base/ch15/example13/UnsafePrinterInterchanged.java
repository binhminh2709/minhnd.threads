package base.ch15.example13;

import base.ch15.GuidedLoopHandler;
import base.ch15.LoopPrinterUnsafe;
import base.ch15.ScaleTester;
...
public class UnsafePrinterInterchanged implements ScaleTester {
    ...
    public float[][] doCalc() {
        UnsafePrinterInterchangedHandler loop = new UnsafePrinterInterchangedHandler(nCols, nThreads);
        loop.loopProcess();
        try {
