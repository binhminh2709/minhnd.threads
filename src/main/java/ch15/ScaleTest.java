...
public class ScaleTest {
  ...
  void chart() {
    ...
    System.err.println("Loop time " + sumTime + " (" + ((sumTime * 100) / calcTime) + "%)");
  ...
  public static void main(String args[]) {
    ...
    ScaleTest sc = new ScaleTest(Integer.parseInt(args[0]), Integer.parseInt(args[1]), Integer.parseInt(args[2]), Integer.parseInt(args[3]), args[4]);
    sc.chart();
  }
}
