...
public class JoiningTimer extends Thread {

    private static final Logger _log = Logger.getLogger(JoiningTimer.class);
    ...
    public JoiningTimer(Component comp, int timediff) {
        this.comp = comp;
