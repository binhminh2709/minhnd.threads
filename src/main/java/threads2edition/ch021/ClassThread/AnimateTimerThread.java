...
public class AnimateTimerThread extends Thread {

    private static final Logger _log = Logger.getLogger(AnimateTimerThread.class);
    ...
    public AnimateTimerThread(Component comp, int timediff) {
