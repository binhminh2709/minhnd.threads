...
public class LifeCycleTimer extends Thread {

    private static final Logger _log = Logger.getLogger(LifeCycleTimer.class);
    ...
    public LifeCycleTimer(Component comp, int timediff) {
        this.comp = comp;
